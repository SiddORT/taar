      ...
      <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-10 py-8">
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-xl font-bold text-cyan-900">{isEdit ? "Edit Packing List" : "New Packing List"}</h1>
          </div>
          <div className="ml-auto flex gap-2">
            <button
              onClick={() => setLocation("/logistics/packing-lists")}
              className="px-4 py-2 rounded-xl text-sm font-medium text-slate-500 bg-white border border-gray-300 hover:bg-gray-50 shadow-sm"
            >
              Cancel
            </button>
            <button
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className={`${card} p-6`}>
              <h2 className="text-sm font-bold text-cyan-900 uppercase tracking-wider mb-4">Grouping</h2>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <select
                    ...
                    className="w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm text-cyan-900 focus:outline-none focus:ring-2 focus:ring-yellow-200"
                    disabled={isEdit}
                  >
            ...
            {/* Shipment + Details */}
            <div className={`${card} p-6`}>
              <h2 className="text-sm font-bold text-cyan-900 uppercase tracking-wider mb-4">Shipment &amp; Details</h2>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <div className="flex items-center justify-between mb-1.5">
                ...
                <div className="sm:col-span-2">
                  ...
                  <textarea
                    ...
                    className="w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm text-cyan-900 focus:outline-none focus:ring-2 focus:ring-yellow-200 resize-none"
                  />
                </div>
              </div>
            </div>
            ...
            <div className={card}>
              <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200">
                <div className="flex items-center gap-2">
                  ...
                  <h2 className="text-sm font-bold text-cyan-900">Packages ({packages.length})</h2>
                </div>
                <button
                  ...
                  {packages.map((pkg, pkgIdx) => (
                    <div key={pkg.tempId} className={`p-5 transition-colors ${activePackageId === pkg.tempId ? "bg-amber-50/40" : ""}`}>
                      ...
                      <div className="flex items-center gap-3 mb-3">
                        ...
                        <span className="font-semibold text-cyan-900 text-sm">Package {pkgIdx + 1}</span>
                            ...
                            {[
                              ...
                              <div key={key}>
                                ...
                                <input
                                  ...
                                  placeholder="0"
                                  className="w-full border border-gray-200 rounded-lg px-2.5 py-1.5 text-sm text-cyan-900 focus:outline-none focus:ring-1 focus:ring-yellow-200"
                                />
                              </div>
                            ))}
                          </div>
                                ...
                                <tbody className="divide-y divide-gray-50">
                                  {pkg.items.map((item, itemIdx) => (
                                    <tr key={itemIdx}>
                                      ...
                                      <td className="px-3 py-2 font-mono text-slate-500">{item.order_code ?? "—"}</td>
                                      <td className="px-3 py-2">
                                        <input
                                          value={item.description}
                                          onChange={e => updateItemField(pkg.tempId, itemIdx, "description", e.target.value)}
                                          className="w-full border border-gray-100 rounded px-1.5 py-0.5 text-xs text-cyan-900 focus:outline-none focus:ring-1 focus:ring-yellow-200"
                                        />
                                      </td>
                                      <td className="px-3 py-2">
                                        <input
                                          ...
                                          className="w-16 border border-gray-100 rounded px-1.5 py-0.5 text-xs text-cyan-900 focus:outline-none focus:ring-1 focus:ring-yellow-200"
                                        />
                                      </td>
                                      <td className="px-3 py-2">
                                        <input
                                          ...
                                          className="w-14 border border-gray-100 rounded px-1.5 py-0.5 text-xs text-cyan-900 focus:outline-none focus:ring-1 focus:ring-yellow-200"
                                        />
                                      </td>
                                      <td className="px-3 py-2">
                                        <input
                ...
                {STATUSES.map(s => (
                  <button
                    ...
                    className={`flex items-center gap-2 px-3 py-2 rounded-xl text-sm font-medium border transition-all ${
                      status === s ? "border-yellow-400 bg-yellow-50 text-cyan-900" : "border-gray-200 text-gray-600 hover:bg-gray-50"
                    }`}
                  >
              ...
              <div className="flex items-center justify-between mb-3">
                <div className="flex gap-1 bg-gray-100 p-1 rounded-lg flex-1 mr-2">
                  <button
                    ...
                    className={`flex-1 py-1 text-xs font-semibold rounded-md transition-all ${rightTab === "orders" ? "bg-white shadow text-cyan-900" : "text-gray-500 hover:text-slate-500"}`}
                  >Orders</button>
                  <button
                    onClick={() => setRightTab("custom")}
                    className={`flex-1 py-1 text-xs font-semibold rounded-md transition-all ${rightTab === "custom" ? "bg-white shadow text-cyan-900" : "text-gray-500 hover:text-slate-500"}`}
                  >Custom Item</button>
                </div>
                {activePackage && (
                  ...
                  <>
                    <div className="flex gap-1 mb-3 bg-gray-100 p-1 rounded-lg">
                      {(["Swatch", "Style"] as const).map(tab => (
                        <button key={tab} onClick={() => setOrderTab(tab)}
                          className={`flex-1 py-1.5 text-xs font-semibold rounded-md transition-all ${orderTab === tab ? "bg-white shadow text-cyan-900" : "text-gray-500 hover:text-slate-500"}`}
                        >
                    ...
                    <div className="relative mb-2">
                      ...
                      <input value={orderSearch} onChange={e => setOrderSearch(e.target.value)} placeholder="Search orders…"
                        className="w-full pl-7 pr-2 py-1.5 border border-gray-200 rounded-lg text-xs text-cyan-900 focus:outline-none focus:ring-1 focus:ring-yellow-200"
                      />
                    </div>
                    ...
                    <div className="flex gap-1 bg-blue-50 p-1 rounded-lg border border-blue-100">
                      {(["material", "fabric", "custom"] as const).map(src => (
                        <button key={src} onClick={() => { setCustomSource(src); setCustomSelected(null); setCustomSearch(""); setInvResults([]); setCustomLocation(""); }}
                          className={`flex-1 py-1 text-xs font-semibold rounded-md capitalize transition-all ${customSource === src ? "bg-white shadow text-cyan-900" : "text-blue-600 hover:text-blue-800"}`}
                        >
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <div>
                        ...
                        <input type="number" min="0" step="any" value={customQty}
                          ...
                          className="w-full border border-gray-200 rounded-lg px-2.5 py-1.5 text-xs text-cyan-900 focus:outline-none focus:ring-1 focus:ring-blue-300"
                        />
                      </div>
                      <div>
          ...
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-lg p-6 max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between mb-5">
              <div className="flex items-center gap-2">
                ...
                <h3 className="font-bold text-cyan-900">Create New Shipment</h3>
              </div>
        ...
        <div className="fixed inset-0 z-50 bg-black/40 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-2xl flex flex-col max-h-[90vh]">
            ...
            <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100 shrink-0">
              <h3 className="font-bold text-cyan-900">Add Delivery Address</h3>
            ...
            <div className="px-6 py-5 space-y-3 overflow-y-auto flex-1">
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full border rounded-xl px-3 py-2 text-sm text-cyan-900 focus:outline-none focus:ring-2 focus:ring-yellow-200 ${addrErrors.pincode ? "border-red-300" : "border-gray-200"}`}
                />
              ...
              {[
                ...
                <div key={key}>
                  ...
                  <input
                    ...
                    className={`w-full border rounded-xl px-3 py-2 text-sm text-cyan-900 focus:outline-none focus:ring-2 focus:ring-yellow-200 ${addrErrors[key] ? "border-red-300" : "border-gray-200"}`}
                  />
              ...
              <label className="flex items-center gap-2 cursor-pointer">
                ...
                <span className="text-sm text-slate-500">Set as default address</span>
              </label>
            </div>
