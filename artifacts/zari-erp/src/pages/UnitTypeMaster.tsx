...
export default function UnitTypeMaster() {
  ...
  const columns: Column[] = [
    ...
    { key: "name", label: "Unit Type Name", render: (r) => <span className="font-medium text-cyan-900">{asRec(r).name}</span> },
  ...
  return (
    <AppLayout username={user.username} role={user.role} onLogout={handleLogout} isLoggingOut={logoutMutation.isPending}>
      <div className="max-w-screen-xl mx-auto space-y-5">
        <MasterHeader title="Unit Type Master" onAdd={openCreate} addLabel="Add Unit Type" />
