      ...
      <div className="mt-3 grid grid-cols-1 sm:grid-cols-2 gap-1.5">
        {callouts.map(c => (
          <div key={c.n} className="flex items-start gap-2 px-2 py-1.5 rounded-lg bg-[#fdf8e7] border border-[#e8d68a]/50">
            ...
            <span className="text-xs text-slate-500 leading-relaxed">{c.label}</span>
          </div>
        ))}
      </div>
    </div>
...
function ModuleCard({ icon: Icon, title, desc, href }: { icon: React.ElementType; title: string; desc: string; href: string }) {
  return (
    <a href={href} className="flex items-start gap-3 p-3 rounded-xl border border-gray-100 hover:border-[#C6AF4B]/40 hover:bg-[#fdf8e7]/40 transition-all group cursor-pointer no-underline">
      ...
      <div>
        <p className="text-sm font-semibold text-cyan-900 group-hover:text-cyan-900">{title}</p>
...
function FeatureRow({ icon: Icon, label, desc }: { icon: React.ElementType; label: string; desc: string }) {
  return (
    <div className="flex items-start gap-3 py-2.5 border-b border-gray-50 last:border-0">
      ...
      <div>
        <span className="text-sm font-medium text-cyan-900">{label}</span>
...
function OverviewContent() {
  return (
    <div>
      ...
      <h3 className="text-sm font-bold text-slate-500 uppercase tracking-wider mb-3">All Modules</h3>
      ...
      <div className="mt-6 p-4 rounded-xl" style={{ background: "#fdf8e7", border: `1px solid ${G}30` }}>
        ...
        <p className="text-sm text-slate-500">Use the left sidebar to jump to any section. Each module section includes feature descriptions, step-by-step instructions, and helpful tips. You can also print this manual using the <strong>Print</strong> button at the top.</p>
      </div>
    </div>
  );
}
...
function LoginContent() {
  return (
    <div>
      ...
      <h3 className="font-semibold text-cyan-900 mb-3">Logging In</h3>
      <Step n={1}>Open the ERP URL in your browser (Chrome or Edge recommended).</Step>
      ...
      <h3 className="font-semibold text-cyan-900 mb-3 mt-4">Navigating the System</h3>
      ...
      <h3 className="font-semibold text-cyan-900 mb-3 mt-6">Access Levels</h3>
      <div className="grid grid-cols-2 gap-3">
        ...
        <div className="p-3 rounded-xl bg-gray-50 border border-gray-100">
          <p className="text-xs font-bold text-slate-500 mb-1">User</p>
...
function DashboardContent() {
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-6">
        {[
          ...
          <div key={c.label} className="flex items-center gap-3 p-3 rounded-xl border border-gray-100 bg-white">
            ...
            <div>
              <p className="text-sm font-semibold text-cyan-900">{c.label}</p>
      ...
      <h3 className="font-semibold text-cyan-900 mb-3">Dashboard Sections</h3>
      <div className="space-y-0">
  ...
  return (
    <div>
      ...
      <div id="clients" className="mb-7">
        <h3 className="font-bold text-cyan-900 mb-1 flex items-center gap-2"><Users className="h-4 w-4" style={{ color: G }} /> Clients</h3>
      ...
      <div id="vendors" className="mb-7">
        <h3 className="font-bold text-cyan-900 mb-1 flex items-center gap-2"><ShoppingBag className="h-4 w-4" style={{ color: G }} /> Vendors</h3>
      ...
      <div id="materials" className="mb-7">
        <h3 className="font-bold text-cyan-900 mb-1 flex items-center gap-2"><Scissors className="h-4 w-4" style={{ color: G }} /> Materials & Fabrics</h3>
      ...
      <div id="hsn" className="mb-7">
        <h3 className="font-bold text-cyan-900 mb-1 flex items-center gap-2"><Hash className="h-4 w-4" style={{ color: G }} /> HSN Codes</h3>
      ...
      <div id="categories" className="mb-7">
        <h3 className="font-bold text-cyan-900 mb-1 flex items-center gap-2"><List className="h-4 w-4" style={{ color: G }} /> Categories & Item Types</h3>
        <div className="space-y-0">
      ...
      <div id="packaging-masters" className="mb-7">
        <h3 className="font-bold text-cyan-900 mb-1 flex items-center gap-2"><Box className="h-4 w-4" style={{ color: G }} /> Item Master (Packaging)</h3>
      ...
      <div id="departments" className="mb-7">
        <h3 className="font-bold text-cyan-900 mb-1 flex items-center gap-2"><Users className="h-4 w-4" style={{ color: G }} /> Departments</h3>
      ...
      <div id="unit-types" className="mb-7">
        <h3 className="font-bold text-cyan-900 mb-1 flex items-center gap-2"><Tag className="h-4 w-4" style={{ color: G }} /> Unit Types</h3>
      ...
      <div id="shipping-vendors" className="mb-7">
        <h3 className="font-bold text-cyan-900 mb-1 flex items-center gap-2"><Truck className="h-4 w-4" style={{ color: G }} /> Shipping Vendors</h3>
...
function SwatchOrdersContent() {
  ...
  return (
    <div>
      ...
      <h3 className="font-semibold text-cyan-900 mb-3">Creating a Swatch Order</h3>
      ...
      <h3 className="font-semibold text-cyan-900 mb-3 mt-6">Order Tabs</h3>
      <div className="space-y-0">
      ...
      <h3 className="font-semibold text-cyan-900 mb-3 mt-6">Order Statuses</h3>
...
function StyleOrdersContent() {
  ...
  return (
    <div>
      ...
      <h3 className="font-semibold text-cyan-900 mb-3">Creating a Style Order</h3>
      ...
      <h3 className="font-semibold text-cyan-900 mb-3 mt-6">Workflow</h3>
...
function QuotationsContent() {
  return (
    <div>
      ...
      <h3 className="font-semibold text-cyan-900 mb-3">Creating a Quotation</h3>
      ...
      <h3 className="font-semibold text-cyan-900 mb-3 mt-5">Quotation Statuses</h3>
      <div className="flex flex-wrap gap-2">
  ...
  return (
    <div>
      ...
      <div id="accounts-dashboard" className="mb-7">
        <h3 className="font-bold text-cyan-900 mb-1 flex items-center gap-2"><LayoutDashboard className="h-4 w-4" style={{ color: G }} /> Accounts Dashboard</h3>
      ...
      <div id="invoices" className="mb-7">
        <h3 className="font-bold text-cyan-900 mb-1 flex items-center gap-2"><Receipt className="h-4 w-4" style={{ color: G }} /> Invoices</h3>
      ...
      <div id="payments" className="mb-7">
        <h3 className="font-bold text-cyan-900 mb-1 flex items-center gap-2"><CreditCard className="h-4 w-4" style={{ color: G }} /> Payments</h3>
      ...
      <div id="cdn" className="mb-7">
        <h3 className="font-bold text-cyan-900 mb-1 flex items-center gap-2"><RotateCcw className="h-4 w-4" style={{ color: G }} /> Credit / Debit Notes</h3>
      ...
      <div id="vendor-ledger" className="mb-7">
        <h3 className="font-bold text-cyan-900 mb-1 flex items-center gap-2"><Database className="h-4 w-4" style={{ color: G }} /> Ledgers (Vendor & Client)</h3>
      ...
      <div id="purchases-accounts" className="mb-7">
        <h3 className="font-bold text-cyan-900 mb-1 flex items-center gap-2"><ShoppingCart className="h-4 w-4" style={{ color: G }} /> Purchases</h3>
      ...
      <div id="sales-accounts" className="mb-7">
        <h3 className="font-bold text-cyan-900 mb-1 flex items-center gap-2"><BarChart2 className="h-4 w-4" style={{ color: G }} /> Sales</h3>
      ...
      <div id="expenses" className="mb-7">
        <h3 className="font-bold text-cyan-900 mb-1 flex items-center gap-2"><DollarSign className="h-4 w-4" style={{ color: G }} /> Other Expenses</h3>
  ...
  return (
    <div>
      ...
      <div id="inv-dashboard" className="mb-7">
        <h3 className="font-bold text-cyan-900 mb-1 flex items-center gap-2"><LayoutDashboard className="h-4 w-4" style={{ color: G }} /> Inventory Dashboard</h3>
      ...
      <div id="stock-list" className="mb-7">
        <h3 className="font-bold text-cyan-900 mb-1 flex items-center gap-2"><List className="h-4 w-4" style={{ color: G }} /> Item Stock List</h3>
      ...
      <div id="low-stock" className="mb-7">
        <h3 className="font-bold text-cyan-900 mb-1 flex items-center gap-2"><AlertTriangle className="h-4 w-4" style={{ color: G }} /> Low Stock Alerts</h3>
      ...
      <div id="ledger" className="mb-7">
        <h3 className="font-bold text-cyan-900 mb-1 flex items-center gap-2"><ClipboardList className="h-4 w-4" style={{ color: G }} /> Stock Ledger</h3>
      ...
      <div id="reservations" className="mb-7">
        <h3 className="font-bold text-cyan-900 mb-1 flex items-center gap-2"><Lock className="h-4 w-4" style={{ color: G }} /> Reservations</h3>
      ...
      <div id="adjustments" className="mb-7">
        <h3 className="font-bold text-cyan-900 mb-1 flex items-center gap-2"><RotateCcw className="h-4 w-4" style={{ color: G }} /> Stock Adjustments</h3>
  ...
  return (
    <div>
      ...
      <div id="vendor-challans" className="mb-7">
        <h3 className="font-bold text-cyan-900 mb-1 flex items-center gap-2"><ClipboardList className="h-4 w-4" style={{ color: G }} /> Vendor Challans</h3>
      ...
      <div id="purchase-orders" className="mb-7">
        <h3 className="font-bold text-cyan-900 mb-1 flex items-center gap-2"><FileText className="h-4 w-4" style={{ color: G }} /> Purchase Orders</h3>
      ...
      <div id="purchase-receipts" className="mb-7">
        <h3 className="font-bold text-cyan-900 mb-1 flex items-center gap-2"><CheckCircle className="h-4 w-4" style={{ color: G }} /> Purchase Receipts</h3>
  ...
  return (
    <div>
      ...
      <div id="packing-lists" className="mb-8">
        <h3 className="font-bold text-cyan-900 mb-1 flex items-center gap-2"><Box className="h-4 w-4" style={{ color: G }} /> Packing Lists</h3>
        ...
        <h4 className="text-sm font-semibold text-slate-500 mb-2">Creating a Packing List</h4>
        ...
        <h4 className="text-sm font-semibold text-slate-500 mb-2 mt-5">Inline Shipment Creation</h4>
        ...
        <h4 className="text-sm font-semibold text-slate-500 mb-2 mt-5">Packing List Statuses</h4>
        <div className="flex flex-wrap gap-2">
      ...
      <div id="shipping" className="mb-7">
        <h3 className="font-bold text-cyan-900 mb-1 flex items-center gap-2"><Send className="h-4 w-4" style={{ color: G }} /> Shipping</h3>
  ...
  return (
    <div>
      ...
      <div id="profile" className="mb-7">
        <h3 className="font-bold text-cyan-900 mb-1 flex items-center gap-2"><UserCheck className="h-4 w-4" style={{ color: G }} /> Profile Settings</h3>
      ...
      <div id="user-management" className="mb-7">
        <h3 className="font-bold text-cyan-900 mb-1 flex items-center gap-2"><Users className="h-4 w-4" style={{ color: G }} /> User Management &amp; Roles</h3>
  ...
  return (
    <div>
      ...
      <div id="report-stock-summary" className="mb-7">
        <h3 className="font-bold text-cyan-900 mb-1 flex items-center gap-2"><Warehouse className="h-4 w-4" style={{ color: G }} /> Stock Summary</h3>
      ...
      <div id="report-stock-movement" className="mb-7">
        <h3 className="font-bold text-cyan-900 mb-1 flex items-center gap-2"><RotateCcw className="h-4 w-4" style={{ color: G }} /> Stock Movement</h3>
      ...
      <div id="report-purchase-summary" className="mb-7">
        <h3 className="font-bold text-cyan-900 mb-1 flex items-center gap-2"><ShoppingCart className="h-4 w-4" style={{ color: G }} /> Purchase Summary</h3>
      ...
      <div id="report-invoice-summary" className="mb-7">
        <h3 className="font-bold text-cyan-900 mb-1 flex items-center gap-2"><Receipt className="h-4 w-4" style={{ color: G }} /> Invoice Summary</h3>
      ...
      <div id="report-vendor-ledger" className="mb-7">
        <h3 className="font-bold text-cyan-900 mb-1 flex items-center gap-2"><Database className="h-4 w-4" style={{ color: G }} /> Vendor Ledger</h3>
      ...
      <div id="report-client-ledger" className="mb-7">
        <h3 className="font-bold text-cyan-900 mb-1 flex items-center gap-2"><Users className="h-4 w-4" style={{ color: G }} /> Client Ledger</h3>
      ...
      <div id="report-order-profitability" className="mb-7">
        <h3 className="font-bold text-cyan-900 mb-1 flex items-center gap-2"><Star className="h-4 w-4" style={{ color: G }} /> Order Profitability</h3>
      ...
      <div id="report-purchase-vs-sales" className="mb-7">
        <h3 className="font-bold text-cyan-900 mb-1 flex items-center gap-2"><BarChart2 className="h-4 w-4" style={{ color: G }} /> Purchase vs Sales</h3>
      ...
      <div id="report-gst-summary" className="mb-7">
        <h3 className="font-bold text-cyan-900 mb-1 flex items-center gap-2"><Hash className="h-4 w-4" style={{ color: G }} /> GST Summary</h3>
    ...
    <div className={`flex flex-col bg-[#f8f9fb] ${printMode ? "" : "h-screen overflow-hidden"}`}>
      ...
      <div className="zari-no-print flex items-center justify-between px-6 py-3 bg-white border-b border-gray-200 shrink-0">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-sm font-bold text-cyan-900">User Manual</h1>
            <p className="text-xs text-gray-400">ERP — Complete Guide</p>
          </div>
        </div>
        ...
        <div className="relative" ref={dlRef}>
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium border border-gray-200 text-slate-500 hover:bg-gray-50 transition-colors"
          >
            ...
            <div className="absolute top-full right-0 mt-1.5 w-56 bg-white border border-gray-200 rounded-xl shadow-lg z-50 overflow-hidden">
              ...
              <div className="p-1">
                ...
                >
                  ...
                  <div>
                    <p className="text-xs font-semibold text-cyan-900">Full Manual</p>
                ...
                >
                  ...
                  <div>
                    <p className="text-xs font-semibold text-cyan-900">Current Section</p>
              ...
              <div className="p-1 space-y-0.5">
                <a
                  href={`${(import.meta.env.BASE_URL ?? "/").replace(/\/$/, "")}/ERP_Scope_Document_v2.pdf`}
                  download="ERP_Scope_Document_v2.pdf"
                ...
                >
                  ...
                  <div>
                    <p className="text-xs font-semibold text-cyan-900">Scope Document <span className="font-normal text-gray-400">(PDF)</span></p>
                    <p className="text-[10px] text-gray-500 mt-0.5">Full project scope · 18 sections</p>
                  </div>
                </a>
                <a
                  href={`${(import.meta.env.BASE_URL ?? "/").replace(/\/$/, "")}/ERP_Scope_Document_v2.docx`}
                  download="ERP_Scope_Document_v2.docx"
                  onClick={() => setDlOpen(false)}
                  className="w-full flex items-start gap-3 px-3 py-2.5 rounded-lg text-left hover:bg-gray-50 transition-colors group"
                >
                  ...
                  <div>
                    <p className="text-xs font-semibold text-cyan-900">Scope Document <span className="font-normal text-gray-400">(DOCX)</span></p>
      ...
      <div className={`flex ${printMode ? "" : "flex-1 overflow-hidden"}`}>
        ...
        <div className="zari-no-print w-56 shrink-0 bg-white border-r border-gray-100 flex flex-col overflow-hidden">
          <div className="p-3 border-b border-gray-100">
            <div className="flex items-center gap-2 px-2.5 py-1.5 rounded-lg bg-gray-50 border border-gray-100">
              ...
              <input
                ...
                className="flex-1 bg-transparent text-xs outline-none text-slate-500 placeholder-gray-400"
              />
            </div>
          </div>
                    ...
                    <div className="ml-4 mb-1 space-y-0.5">
                      {s.subsections.map(sub => (
                        <a
                          ...
                          className="block px-2.5 py-1.5 rounded-lg text-xs text-gray-500 hover:bg-gray-50 hover:text-cyan-900 transition-colors truncate"
                        >
                          {sub.label}
                        </a>
                      ))}
          ...
          <div className="p-3 border-t border-gray-100">
            <p className="text-[10px] text-gray-400 text-center">ERP © 2026</p>
          </div>
        </div>
