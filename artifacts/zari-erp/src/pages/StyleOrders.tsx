      ...
      <div className="p-5">
        <div className="flex items-start justify-between gap-3 mb-3">
          <div className="flex-1 min-w-0">
            ...
            <h3 className="text-sm font-semibold text-cyan-900 truncate">{order.styleName}</h3>
            {order.clientName && (
    ...
    <AppLayout username={user.username} role={user.role} onLogout={handleLogout} isLoggingOut={logoutMutation.isPending}>
      <div className="max-w-screen-xl mx-auto space-y-5">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-xl font-semibold text-cyan-900">Style Orders</h1>
              ...
              <tbody className="divide-y divide-gray-50">
                {orders.map(order => (
                  <tr key={order.id} className="hover:bg-[#C6AF4B]/04 transition-colors">
                    ...
                    <td className="px-4 py-3 font-medium text-cyan-900">{order.styleName}</td>
