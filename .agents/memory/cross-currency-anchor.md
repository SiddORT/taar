...
- vendor bills are CREATED in procurement.ts hardcoded INR (rate 1, base = vendor_invoice_amount). Cross-currency lives on the payment side only — internally consistent.
